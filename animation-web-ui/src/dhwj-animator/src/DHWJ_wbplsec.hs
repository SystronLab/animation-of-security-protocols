...
module
  DHWJ_wbplsec(get_messages, msg12_agent_send, wm_msg12_agent_send,
...
wm_msg12_agent_send a =
  Sec_Messages.MWat (msg12_agent_send a) (DHWJ_config.mkbma a);
...
all_wm_msg12_agent_recv a =
  map wm_msg12_agent_send (DHWJ_config.allOtherAgents a);
...
all_wm_msg3_agent_recv b =
  map (\ a ->
        Sec_Messages.MWat
          (Sec_Messages.MSEnc (Sec_Messages.MK (DHWJ_config.pks a))
  ...
  concatMap
    (\ m ->
      map (\ ba -> Sec_Messages.Cjam_C (Sec_Messages.MJam m ba))
        [DHWJ_config.mkbma b, Sec_Messages.MBitm Sec_Messages.Null])
      ...
      Interaction_Trees.bind_itree
        ...
        (\ (_, (_, (aa, m))) ->
          ITree_CSP.outp Sec_Messages.cjam
            (Sec_Messages.MJam m
              (if inrange then DHWJ_config.mkbma aa
...
wm_msg4_agent_send b mpk nb gx =
  Sec_Messages.MWat (msg4_agent_send mpk nb gx) (DHWJ_config.mkbma b);
    ...
    (\ _ ->
      Interaction_Trees.bind_itree
        (ITree_CSP.inp_list_where Sec_Messages.cjam
          (map (\ m -> Sec_Messages.MJam m (DHWJ_config.mkbma b))
          ...
          let {
            gx = Sec_Messages.mwm (Sec_Messages.mjm m1);
                 ...
                 (\ _ ->
                   Interaction_Trees.bind_itree
                     (ITree_CSP.inp_list_where Sec_Messages.cjam
                       (map (\ m3 -> Sec_Messages.MJam m3 (DHWJ_config.mkbma b))
                         (all_wm_msg3_agent_recv b))
                       (\ _ -> True))
                     (\ m3 ->
                       let {
...
all_wm_msg4_agent_recv a =
  concatMap
    (\ b ->
      map (\ c ->
            Sec_Messages.MWat
              (Sec_Messages.MSEnc (Sec_Messages.MK (DHWJ_config.pks b))
  ...
  concatMap
    (\ m ->
      map (\ b -> Sec_Messages.Cjam_C (Sec_Messages.MJam m b))
        [DHWJ_config.mkbma a, Sec_Messages.MBitm Sec_Messages.Null])
...
wm_msg3_agent_send a na gy =
  Sec_Messages.MWat (msg3_agent_send a na gy) (DHWJ_config.mkbma a);
    ...
    (\ (_, b) ->
      Interaction_Trees.bind_itree
        ...
        (\ _ ->
          Interaction_Trees.bind_itree
            (ITree_CSP.inp_list_where Sec_Messages.cjam
              (map (\ m -> Sec_Messages.MJam m (DHWJ_config.mkbma a))
                (all_wm_msg12_agent_recv a))
              (\ _ -> True))
            (\ m ->
              let {
...
(DHWJ_config.mkbma a))
  ...
  (Sec_Messages.MModExp gy (Sec_Messages.MNon na))
         ...
         (Sec_Messages.MK (DHWJ_config.pks a))
     then Interaction_Trees.bind_itree
            (ITree_CSP.outp Sec_Messages.sig
...
all_msg12_agent_recv ::
  Sec_Messages.Dagent (Numeral_Type.Bit0 Numeral_Type.Num1) ->
    [Sec_Messages.Dmsg (Numeral_Type.Bit0 Numeral_Type.Num1)
       ...
       Numeral_Type.Num1 (Numeral_Type.Bit1 Numeral_Type.Num1)
       (Numeral_Type.Bit0 Numeral_Type.Num1)];
all_msg12_agent_recv a = map msg12_agent_send (DHWJ_config.allOtherAgents a);
        ...
        (\ m ->
          map (Sec_Messages.MJam m)
            [(if Interaction_Trees.pfun_app
                   ...
                   b
               then DHWJ_config.mkbma b
               else Sec_Messages.MBitm Sec_Messages.Null)])
        (all_wm_msg123_agent_send a))
    DHWJ_config.allCommsAgentsButIntr;
              ...
              (map (\ ba ->
                     Sec_Messages.MJam m
                       (if Interaction_Trees.pfun_app
                             ...
                             ba
                         then DHWJ_config.mkbma ba
                         else Sec_Messages.MBitm Sec_Messages.Null))
                (DHWJ_config.allOtherAgentsButIntr a)))
            Set.bot_set
...
pIntruder eve =
  pIntruder1 Sec_Messages.Intruder
    ((Interaction_Trees.pfun_app ::
      ...
      Sec_Messages.Intruder)
    DHWJ_config.initKnows DHWJ_config.allSecrets eve;
...
dHWJ_active_eve4 =
  (if DHWJ_config.equal_deve DHWJ_config.Eve1 DHWJ_config.Eve2
    then dHWJ_active DHWJ_config.Eve4 else dHWJ_active DHWJ_config.Eve4);
