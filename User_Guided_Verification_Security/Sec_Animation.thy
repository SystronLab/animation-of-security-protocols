...
Haskell module are updated specifically for security protocols. 
\<close>
...
ppMBitm (Null) = "BMNull";
ppMBitm (Bm bm bl) = "BM"  ++ ppNmk bm ++ ":" ++ ppNmk bl;
...
formatEvents :: (Chan a b c d e f g) -> (String, String, String, String, String); 
...
-- EChan: Chan event 
data TEvent a b c d e f g = Root | Deadlocked | Terminated | Divergent | EChan (Sec_Messages.Chan a b c d e f g) 
...
data TEventPos a b c d e f g = TEP Int Int (TEvent a b c d e f g)
  deriving (Eq, Read, Show, Generic)

-- | Event tree
data EventTree a b c d e f g = ETNode (TEventPos a b c d e f g) [EventTree a b c d e f g] 
  deriving (Eq, Read, Show, Generic)

-- | Format a tree event to text
formatTEvent :: TEvent a b c d e f g -> Text
...
formatTEvents :: [TEvent a b c d e f g] -> Text
...
explore_tree_cnt :: (Prelude.Show s) => forall a b c d e f g. Itree (Chan a b c d e f g) s -> Int -> Int -> Int -> Int -> [EventTree a b c d e f g]; 
